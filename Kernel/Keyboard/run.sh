...
ld -m elf_i386 -T linker.ld kernel.o utils.o char.o boot.o -o Kernel_Keyboard_OS.bin -nostdlib

# check Kernel_Keyboard_OS.bin file is x86 multiboot file or not
grub-file --is-x86-multiboot Kernel_Keyboard_OS.bin

# building the iso file
mkdir -p isodir/boot/grub
cp Kernel_Keyboard_OS.bin isodir/boot/Kernel_Keyboard_OS.bin
